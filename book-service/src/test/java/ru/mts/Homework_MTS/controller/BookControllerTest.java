...
//    @Test
//    void e2eTest() {
//        BookRequestToCreate bookRequestToCreate = new BookRequestToCreate(new Author("Michael", "John"), "Brand new book", new HashSet<>());
...
//
//        BookRequestToUpdate bookRequestToUpdate = new BookRequestToUpdate(new Author("Michael", "John"), "New Title", new HashSet<>());
